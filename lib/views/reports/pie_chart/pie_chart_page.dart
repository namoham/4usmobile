...
class PieChartPageTest extends StatefulWidget {
  ...
  String chartQuery;
  PieChartPageTest(this.signOut, this.userLoginId, this.chartQuery);

  @override
  State<StatefulWidget> createState() => PieChartPageState(this.signOut, this.userLoginId, this.chartQuery);
}
...
class PieChartPageState extends State {
  ...
  PieChartPageState(this.signOut, this.userLoginId, this.chartQuery);
